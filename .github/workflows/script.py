...
yelp_df.write.json("s3://scriptdata/business_final/", mode = "overwrite")
tip_sent.write.json("s3://scriptdata/tips_final/", mode = "overwrite")
checkin_df.write.json("s3://scriptdata/checkin_final/", mode = "overwrite")
rev_sentiment.write.json("s3://scriptdata/review_final/", mode = 'overwrite')
df.write.json("s3://scriptdata/user_final/", mode = 'overwrite')
